...
# particles need to be generated.
    ...
    print('#  x y z     u v w')
    # 100005 generates  50000 partcles for 100 sec.
    # 200005 generates 100000 partcles for 200 sec.
    # 300005 generates 150000 partcles for 300 sec.
    for ti in range(0, 300005, 5):
        tm = ti % 5000
        if tm >= 0 and tm < 2500:
