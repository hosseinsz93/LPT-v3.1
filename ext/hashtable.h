...
#ifndef _MKHASH_HASHTABLE_H
#define _MKHASH_HASHTABLE_H 1
...
namespace MKHash
{
  ...
  template <class _Val, class _Key, class _HashFcn,
    ...
    struct _Hashtable_iterator
    {
      ...
      typedef MKHash::MKHashStd::forward_iterator_tag iterator_category;
  ...
  template <class _Val, class _Key, class _HashFcn,
    ...
    public:
      ...
      template <class _InputIterator>
        ...
        { insert_unique(__f,__l,MKHash::MKHashStd::MKHASH__iterator_category(__f)); }

      template <class _InputIterator>
        void
        insert_equal(_InputIterator __f, _InputIterator __l)
        { insert_equal(__f, __l, MKHash::MKHashStd::MKHASH__iterator_category(__f));}
      ...
      template <class _ForwardIterator>
        ...
        insert_unique(_ForwardIterator __f, _ForwardIterator __l,
                      MKHash::MKHashStd::forward_iterator_tag)
        {
          size_type __n = MKHash::MKHashStd::distance(__f, __l);
