#ifndef _GEOM_HEAD_EXCEPTION
#define _GEOM_HEAD_EXCEPTION
...
namespace Geom
{
  class HeadException : public std::exception
  {
  public:
    HeadException();
    HeadException(std::string const &description);
  ...
  class InvalidIndex : public HeadException
  {
  public:
    InvalidIndex(int const &id);
    ~InvalidIndex() throw() {}
  };
   ...
   */
  class MasterSerialException : public HeadException
  {
  public:
