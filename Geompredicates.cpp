// turn off global optimization for windows for the whole file
#ifdef _WIN32
...
/*    processors that do not use the round-to-even tie breaking rule) is     */
...
#include <stdlib.h>
#include <cmath>
#if (defined(__MINGW32__) || ! defined(WIN32)) && ! defined(PROSTAR_STATIC)
// non-gnu windows does not have this include. Is it needed on any system?
#include <sys/time.h>
#endif
#include "Geompredicates.h"
#include "Geomrounding.h"

// This include automatically runs the exactinit code
#include "GeompredicateInitializer.h"
...
/*   `wi', `wj', `wk', `wl', `wm', and `wn' are declared `INEXACT' because   */
...
#define Two_Two_Sum(a1, a0, b1, b0, x3, x2, x1, x0) \
  Two_One_Sum(a1, a0, b0, wj, w0, x0); \
  Two_One_Sum(wj, w0, b1, x3, x2, x1)

#define Two_Two_Diff(a1, a0, b1, b0, x3, x2, x1, x0) \
  Two_One_Diff(a1, a0, b0, wj, w0, x0); \
  Two_One_Diff(wj, w0, b1, x3, x2, x1)

#define Four_One_Sum(a3, a2, a1, a0, b, x4, x3, x2, x1, x0) \
  Two_One_Sum(a1, a0, b , wj, x1, x0); \
  Two_One_Sum(a3, a2, wj, x4, x3, x2)

#define Four_Two_Sum(a3, a2, a1, a0, b1, b0, x5, x4, x3, x2, x1, x0) \
  Four_One_Sum(a3, a2, a1, a0, b0, wk, w2, w1, w0, x0); \
  Four_One_Sum(wk, w2, w1, w0, b1, x5, x4, x3, x2, x1)

#define Four_Four_Sum(a3, a2, a1, a0, b4, b3, b1, b0, x7, x6, x5, x4, x3, x2, \
                      x1, x0) \
  Four_Two_Sum(a3, a2, a1, a0, b1, b0, wl, w2, w1, w0, x1, x0); \
  Four_Two_Sum(wl, w2, w1, w0, b4, b3, x7, x6, x5, x4, x3, x2)

#define Eight_One_Sum(a7, a6, a5, a4, a3, a2, a1, a0, b, x8, x7, x6, x5, x4, \
                      x3, x2, x1, x0) \
  Four_One_Sum(a3, a2, a1, a0, b , wj, x3, x2, x1, x0); \
  Four_One_Sum(a7, a6, a5, a4, wj, x8, x7, x6, x5, x4)

#define Eight_Two_Sum(a7, a6, a5, a4, a3, a2, a1, a0, b1, b0, x9, x8, x7, \
                      x6, x5, x4, x3, x2, x1, x0) \
  Eight_One_Sum(a7, a6, a5, a4, a3, a2, a1, a0, b0, wk, w6, w5, w4, w3, w2, \
                w1, w0, x0); \
  Eight_One_Sum(wk, w6, w5, w4, w3, w2, w1, w0, b1, x9, x8, x7, x6, x5, x4, \
                x3, x2, x1)

#define Eight_Four_Sum(a7, a6, a5, a4, a3, a2, a1, a0, b4, b3, b1, b0, x11, \
                       x10, x9, x8, x7, x6, x5, x4, x3, x2, x1, x0) \
  Eight_Two_Sum(a7, a6, a5, a4, a3, a2, a1, a0, b1, b0, wl, w6, w5, w4, w3, \
                w2, w1, w0, x1, x0); \
  Eight_Two_Sum(wl, w6, w5, w4, w3, w2, w1, w0, b4, b3, x11, x10, x9, x8, \
                x7, x6, x5, x4, x3, x2)
...
#define Two_One_Product(a1, a0, b, x3, x2, x1, x0) \
  Split(b, bhi, blo); \
  Two_Product_Presplit(a0, b, bhi, blo, wi, x0); \
  Two_Product_Presplit(a1, b, bhi, blo, wj, w0); \
  Two_Sum(wi, w0, wk, x1); \
  Fast_Two_Sum(wj, wk, x3, x2)
...
#define Four_One_Product(a3, a2, a1, a0, b, x7, x6, x5, x4, x3, x2, x1, x0) \
  ...
  Two_Product_Presplit(a1, b, bhi, blo, wj, w0); \
  Two_Sum(wi, w0, wk, x1); \
  Fast_Two_Sum(wj, wk, wi, x2); \
  Two_Product_Presplit(a2, b, bhi, blo, wj, w0); \
  Two_Sum(wi, w0, wk, x3); \
  Fast_Two_Sum(wj, wk, wi, x4); \
  Two_Product_Presplit(a3, b, bhi, blo, wj, w0); \
  Two_Sum(wi, w0, wk, x5); \
  Fast_Two_Sum(wj, wk, x7, x6)

#define Two_Two_Product(a1, a0, b1, b0, x7, x6, x5, x4, x3, x2, x1, x0) \
  Split(a0, a0hi, a0lo); \
  Split(b0, bhi, blo); \
  Two_Product_2Presplit(a0, a0hi, a0lo, b0, bhi, blo, wi, x0); \
  Split(a1, a1hi, a1lo); \
  Two_Product_2Presplit(a1, a1hi, a1lo, b0, bhi, blo, wj, w0); \
  Two_Sum(wi, w0, wk, w1); \
  Fast_Two_Sum(wj, wk, wl, w2); \
  Split(b1, bhi, blo); \
  Two_Product_2Presplit(a0, a0hi, a0lo, b1, bhi, blo, wi, w0); \
  Two_Sum(w1, w0, wk, x1); \
  Two_Sum(w2, wk, wj, w1); \
  Two_Sum(wl, wj, wm, w2); \
  Two_Product_2Presplit(a1, a1hi, a1lo, b1, bhi, blo, wj, w0); \
  Two_Sum(wi, w0, wn, w0); \
  Two_Sum(w1, w0, wi, x2); \
  Two_Sum(w2, wi, wk, w1); \
  Two_Sum(wm, wk, wl, w2); \
...
#define Two_Square(a1, a0, x5, x4, x3, x2, x1, x0) \
  Square(a0, wj, x0); \
  w0 = a0 + a0; \
  Two_Product(a1, w0, wk, w1); \
  Two_One_Sum(wk, w1, wj, wl, w2, x1); \
  Square(a1, wj, w1); \
  Two_Two_Sum(wj, w1, wl, w2, x5, x4, x3, x2)
...

{
  ...
  //fprintf(stdout,"CALLING EXACTINIT\n");
  //fflush(stdout);
...
/*****************************************************************************/
/*                                                                           */
/*  estimate()   Produce a one-word estimate of an expansion value.          */
/*                                                                           */
...
static REAL orient2dslow(REAL *pa, REAL *pb, REAL *pc)
{
  ...
  REAL err1, err2, err3;
  INEXACT REAL wi, wj, wk, wl, wm, wn;
  REAL w0, w1, w2;
...
/*               co-circular.  The points pa, pb, and pc must be in          */
/*               counterclockwise order, or the sign of the result will be   */
/*               reversed.                                                   */
/*                                                                           */
/*  Only the first and last routine should be used; the middle two are for   */
/*  timings.                                                                 */
